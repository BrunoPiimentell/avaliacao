...
namespace avaliação
{
    class Produto
    {
        ...
        SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Aluno\source\repos\avaliação\DbGeek.mdf;Integrated Security=True");
